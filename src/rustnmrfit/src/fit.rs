...
pub struct Fit1D {
    ...
    // NMRFit object holding gradients and lineshape fit
...
impl Fit1D {
    ...
    pub fn new(x: Array<f64, Ix1>, y: Array<f64, Ix2>, nl: usize, nb: usize, np: usize,
        ...
        Fit1D {
            ...
            lineshape: Lineshape1D::new_flat(x, nl),
            basis: basis,
...
impl Fit1D {
    ...
    pub fn eval(&mut self, p: &[f64], grad: Option<&mut [f64]>) -> f64 {
        ...
        self.lineshape.calculate_flat(p);

        // Updating with lineshapes
        self.y_fit += &self.lineshape.y.slice(s![.., 0, ..]);
