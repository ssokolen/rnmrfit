...
#define SWIGTYPE_p_nlopt_opt swig_types[10]
#define SWIGTYPE_p_nlopt_result swig_types[11]
#define SWIGTYPE_p_size_type swig_types[12]
#define SWIGTYPE_p_std__out_of_range swig_types[13]
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        {
          void *ptr;
          int res = SWIG_ConvertPtr(argv[2], &ptr, SWIGTYPE_p_std__vectorT_double_t, SWIG_POINTER_NO_NULL);
          _v = SWIG_CheckState(res);
        }
        if (_v) {
